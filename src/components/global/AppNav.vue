<template>
  <div class="nav-bar">
    <v-app-bar color="blue" class="pt-3" height="fit-content" absolute>
      ...
      <v-container fluid>
          ...
          <v-col cols="5">
            <div class="position-relative" style="width: 100%">
              <input
                ...
                id="navSearch"
                placeholder="Search ..."
                style="width: 100%; border-radius: 5px; outline: none"
                class="py-3 px-5 bg-white pr-8"
              />
              <svg
                data-icon="search"
                viewBox="0 0 512 512"
          ...
          <v-col cols="4" class="ps-8">
            ...
            >
              <div class="available">
                ...
                <br />
                <strong>(092) 1232132</strong>
              </div>
              <div
                class="wistlist d-flex flex-column align-center text-orange"
        ...
        C482,254.358,413.255,312.939,309.193,401.614z"
              ...
              <div
                class="cart d-flex flex-column align-center text-orange"
                @click="toggleDrawer"
              >
                <v-badge
                  location="right top"
    ...
    selectedLang: [
      {
        icon: `
          <svg
            ...
            y="0px"
            viewBox="0 0 512 512"
            style="enable-background: new 0 0 512 512; width: 28px"
            xmlns:xlink="http://www.w3.org/1999/xlink"
            xml:space="preserve"
          >
            <circle
